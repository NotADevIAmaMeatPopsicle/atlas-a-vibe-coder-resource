...
The public-content verifier audits reachable commit metadata as well as files.
Configure Git to use your GitHub-provided no-reply address before committing if
you do not want a personal email address recorded in public history.
