...
/**
 * Encode terminal controls without collapsing them into an existing visible
 * backslash escape. This is intended for versioned human-readable artifacts;
 * JSON output keeps using terminalSafeText so its formatting is unchanged.
 */
export function terminalSafeDisplayText(value: string): string {
  return value.replace(
    /\\|[\u0000-\u0008\u000b\u000c\u000e-\u001f\u007f-\u009f\u061c\u200e\u200f\u2028\u2029\u202a-\u202e\u2066-\u2069]/gu,
    (character) => character === '\\'
      ? '\\\\'
...
export function terminalSafeJson(value: unknown): string {
  return terminalSafeText(prettyCanonicalJson(value));
}
