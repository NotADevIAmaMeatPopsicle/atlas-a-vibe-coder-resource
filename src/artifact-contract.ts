...
export const TRIAGE_REPORT_PRIOR_VERSION = '1.2.0' as const;
export const TRIAGE_REPORT_VERSION = '1.3.0' as const;
...
export const TRIAGE_REPORT_PRIOR_ANALYSIS_MARKER = `triage-report-v${TRIAGE_REPORT_PRIOR_VERSION}` as const;
