...
As verified on 2026-09-06, `npm audit --omit=dev` reports zero known
vulnerabilities. The lockfile uses `fast-uri` 3.1.7, which is beyond the 3.1.6
fix boundary for the four URI-normalization advisories that affected the
earlier 3.1.5 lock.
