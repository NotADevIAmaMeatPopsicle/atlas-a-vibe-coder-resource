...
`triage-report-v1.3.0` marker. A current
...
run artifact selected by current `triage-report-v1.3.0`; the verifier recomputes
...
with detailed instances retained in `diagnostics.jsonl`. Historical v1.0.0,
v1.1.0, and v1.2.0 triage artifacts remain verifiable through their byte-exact
renderers.
