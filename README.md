...
GitHub Actions runs the same check on Node.js 22 under Ubuntu and Windows for
pull requests and updates to `main`. CodeQL separately analyzes JavaScript and
TypeScript changes and runs on a weekly schedule.
